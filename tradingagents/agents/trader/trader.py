...
{build_chinese_output_instruction("Keep the final literal control phrase FINAL TRANSACTION PROPOSAL: **BUY/HOLD/SELL** in English exactly as written, but write the surrounding analysis in Chinese.")}""",
            },
            context,
        ]
